...
/**
 * RPG Mod özel canlısı: River Otter (Nehir Su Samuru).
 * Rabbit gövde ailesini (vanilla model/animasyon) kullanır, kendi
 * can/hasar/hız değerleri ve dokusu ile ayrı bir canlı türüdür.
 */
public class RiverOtterEntity extends Rabbit {

    public RiverOtterEntity(EntityType<? extends RiverOtterEntity> type, Level level) {
        super(type, level);
    }
