...
/**
 * RPG Mod özel canlısı: Woodland Sprite (Orman Perisi).
 * Zombie gövde ailesini (vanilla model/animasyon) kullanır, kendi
 * can/hasar/hız değerleri ve dokusu ile ayrı bir canlı türüdür.
 */
public class WoodlandSpriteEntity extends Husk {

    public WoodlandSpriteEntity(EntityType<? extends WoodlandSpriteEntity> type, Level level) {
        super(type, level);
    }
