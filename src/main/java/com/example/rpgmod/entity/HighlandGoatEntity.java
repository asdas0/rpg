...
/**
 * RPG Mod özel canlısı: Highland Goat (Yayla Keçisi).
 * Cow gövde ailesini (vanilla model/animasyon) kullanır, kendi
 * can/hasar/hız değerleri ve dokusu ile ayrı bir canlı türüdür.
 */
public class HighlandGoatEntity extends Cow {

    public HighlandGoatEntity(EntityType<? extends HighlandGoatEntity> type, Level level) {
        super(type, level);
    }
